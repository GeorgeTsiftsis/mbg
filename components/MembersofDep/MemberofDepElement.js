function MemberofDepElement({ membername, role, img, sector, link }) {
  return (
    <div className="flex font-manrope  flex-col w-full  sm:w-auto p-4 m-6 border-myblue border-2 items-center rounded-lg bg-myfooter">
